...
$sex = $_SESSION['sex'];
$nameL = $_SESSION['nameL'];
$numbers = $_SESSION['numbers'];
$id_card = $_SESSION['id_card'];
$certi = $_SESSION['certi'];

$cs_id = htmlspecialchars($_GET['cs_id']);

$data_regis = array();
$data_regis['cr_email'] = $email;
$data_regis['cr_genders'] = $sex;
$data_regis['cr_name'] = $nameL;
$data_regis['cr_numbers'] = $numbers;
$data_regis['cr_card_id'] = $id_card;
$data_regis['cr_certi'] = $certi;
$data_regis['cs_id'] = $cs_id;

include_once "../model/ConDB.php";
include_once "../model/Course.php";
$obj_name = new Course();
$rs2 = $obj_name->addRegisterCourse($data_regis);
